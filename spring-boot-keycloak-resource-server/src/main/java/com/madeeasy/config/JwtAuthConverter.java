...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    /**
     * when json will look like :: role mappings => from user role to [find by] client role
     * "realm_access": {
     * "roles": [
     * "offline_access",
     * "default-roles-pabitra",
     * "uma_authorization"
     * ]
     * },
     * "resource_access": {
...
//    }
    ...
    /**
     * method #2
     * when json will look like :: role mappings => from user role to [find by] realm role
     * "realm_access": {
     * "roles": [
     * "offline_access",
     * "default-roles-pabitra",
